...
<body class="index-page sidebar-collapse">
  ...
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
    <div class="container">
      <div class="navbar-translate index-logo">
        
            <a href="/">
                <img src="{{ asset('storage/icons/ISOTIPOs.png') }}" id="logo">
            </a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="{{ asset('estatic/assets/img/blurred-image-1.jpg')}}">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="javascript:void(0)" onclick="Contactos()">
              {{-- <i class="now-ui-icons arrows-1_cloud-download-93"></i> --}}
              <p>Contactos</p>
            </a>
          </li>
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Twitter" data-placement="bottom" href="https://twitter.com/lottuxmed" target="_blank">
              <i class="fab fa-twitter"></i>
              <p class="d-lg-none d-xl-none">Twitter</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Facebook" data-placement="bottom" href="https://www.facebook.com/lottuxmed" target="_blank">
              <i class="fab fa-facebook-square"></i>
              <p class="d-lg-none d-xl-none">Facebook</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Instagram" data-placement="bottom" href="https://www.instagram.com/lottuxmed" target="_blank">
  ...
  <div class="wrapper">
    <div class="page-header clear-filter" filter-color="blue">
      <div class="page-header-image" data-parallax="true" style="background-image:url('{{ asset('estatic/assets/img/header.jpg')}}');">
      </div>
      <div class="container">
        <div class="content-center brand">
          <img class="n-logo" src="{{ asset('storage/icons/ISOTIPOs.png') }}" alt="">
           <h1 class="h1-seo"> <img {{--class="n-logo"--}} src="{{ asset('storage/icons/NOMBRE.png') }}" style="width:50%;"></h1> 
          <h3>"La tecnología por sí sola no basta. También tenemos que poner el corazón."</h3>
        </div>
        {{-- <h6 class="category category-absolute">Designed by
          <a href="http://invisionapp.com/" target="_blank">
            <img src="{{ asset('estatic/assets/img/invision-white-slim.png')}}" class="invision-logo" />
          </a>. Coded by
          <a href="https://www.creative-tim.com" target="_blank">
            <img src="{{ asset('estatic/assets/img/creative-tim-white-slim2.png') }}" class="creative-tim-logo" />
          </a>.</h6> --}}
      </div>
    </div>
    <div class="main">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="hero-images-container">
                <img src="{{ asset('estatic/assets/img/hero-image-1.png') }} " alt="">
              </div>
              <div class="hero-images-container-1">
                <img src="{{ asset('estatic/assets/img/hero-image-2.png')}}" alt="">
              </div>
              <div class="hero-images-container-2">
                <img src="{{ asset('estatic/assets/img/hero-image-3.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      {{-- <div class="section section-navbars">
            ...
            <div class="col-md-6">
              ...
              <nav class="navbar navbar-expand-lg bg-primary">
                <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="example-navbar" data-nav-image="{{ asset('estaticassets/img/blurred-image-1.jpg')}}">
                    <ul class="navbar-nav">
        ...
        <div id="navbar">
          <div class="navigation-example" style="background-image:url('{{ asset('estatic/assets/img/bg7.jpg')}}')">
            <!-- Navbar Primary  -->
            <nav class="navbar navbar-expand-lg bg-primary">
              <div class="container">
          ...
          <div id="images">
            ...
            <div class="row">
              <div class="col-sm-2">
                ...
                <img src="{{ asset('estatic/assets/img/julie.jpg') }}" alt="Rounded Image" class="rounded">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Image</p>
                <img src="{{ asset('estatic/assets/img/julie.jpg') }}" alt="Circle Image" class="rounded-circle">
              </div>
              <div class="col-sm-2">
                <p class="category">Raised</p>
                <img src="{{ asset('estatic/assets/img/julie.jpg') }}" alt="Raised Image" class="rounded img-raised">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Raised</p>
                <img src="{{ asset('estatic/assets/img/julie.jpg') }}" alt="Thumbnail Image" class="rounded-circle img-raised">
              </div>
            </div>
          </div>
        </div>
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active">
                    <img class="d-block" src="{{ asset('estatic/assets/img/bg1.jpg') }}" alt="First slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Nature, United States</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block" src="{{ asset('estatic/assets/img/bg3.jpg') }}" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Somewhere Beyond, United States</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block" src="{{ asset('estatic/assets/img/bg4.jpg') }}" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
      ...
      <div class="section section-signup Contactos" style="background-image: url('{{ asset('estatic/assets/img/bg11.jpg') }}'); background-size: cover; background-position: top center; min-height: 700px;">
        <div class="container">
          <div class="row">
            <div class="card card-signup" data-background-color="orange">
              <form class="form" method="" action="">
                <div class="card-header text-center">
                  <h3 class="card-title title-up">Contactos</h3>
                  <div class="social-line">
                    <a target="_blank" href="https://www.facebook.com/lottuxmed" class="btn btn-neutral btn-facebook btn-icon btn-round">
                      <i class="fab fa-facebook-square"></i>
                    </a>
                    <a target="_blank" href="https://www.twitter.com/lottuxmed" class="btn btn-neutral btn-twitter btn-icon btn-lg btn-round">
                      <i class="fab fa-twitter"></i>
                    </a>
                    <a target="_blank" href="https://www.instagram.com/lottuxmed" class="btn btn-neutral btn-google btn-icon btn-round">
                      <i class="fab fa-instagram"></i>
                    </a>
                  </div>
                </div>
                ...
                <h5 class="text-center">3 # 25, Módulo A2. Imperial, STGO. 51000</h5>
                <h5 class="text-center"><b>Servicio al cliente:</b> 829-971-3264 Ext. 221</h5> 
                  ...
                  <div class="input-group no-border">
                    ...
                    <textarea class="form-control"  cols="85%" placeholder="Mensaje"></textarea>
                  </div>
                ...
                <div class="card-footer text-center">
                  <a href="#pablo" class="btn btn-neutral btn-round btn-lg">Enviar</a>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col">
              <a href="examples/landing-page.html" target="_blank">
                <img src="{{ asset('estatic/assets/img/landing.jpg ')}}" alt="Image" class="img-raised">
              </a>
              <a href="examples/landing-page.html" class="btn btn-outline-default btn-primary btn-round">View Landing Page</a>
            </div>
            <div class="col">
              <a href="examples/profile-page.html" target="_blank">
                <img src="{{ asset('estatic/assets/img/profile.jpg') }}" alt="Image" class="img-raised">
              </a>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="member add-animation-stopped animation-2">
                                    <img alt="..." class="img-circle" src="{{ asset('estatic/assets/img/faces/juan luis.jfif') }}"/>
                                    <div class="description">
                                        <h3 class="big-text">Juan Luis</h3>
                            ...
                            <div class="col-md-4">
                                <div class="member add-animation-stopped animation-3">
                                    <img alt="..." class="img-circle" src="{{ asset('estatic/assets/img/faces/luri.jfif') }}"/>
                                    <div class="description">
                                        <h3 class="big-text">Lurina</h3>
                            ...
                            {{-- <div class="col-md-4">
                                <div class="member add-animation-stopped animation-4">
                                    <img alt="..." class="img-circle" src="{{ asset('estatic/assets/img/faces/face_10.jpg') }}"/>
                                    <div class="description">
      ...
      <div class="section section-download" data-background-color="black">
        <div class="space-50"></div>
        <div class="container text-center">
          <div class="row">
            <div class="col">
                <h3 class="title">Mision</h3>
                <h5 class="description">Contribuir al crecimiento de nuestros clientes ofreciéndole nuestros servicios tecnológicos y financieros amparados en el mejoramiento continuo.</h5>
            </div>
            <div class="col">
                <h3 class="title">Vision</h3>
                <h5 class="description">Posicionarnos en el sector como una de las empresas líderes en la prestación de servicios tecnológicos y financieros, para ellos empleando un personal profesional y humano que conduzca al mejoramiento continuo dentro de un ambiente de motivación y respeto.</h5>
            </div>
            <div class="col">
      ...
      {{-- <div class="section section-download" id="#download-section" data-background-color="black">
        <div class="container">
          ...
          <div class="row justify-content-md-center sharing-area text-center">
            ...
            <div class="text-center col-md-12 col-lg-8">
              <a target="_blank" href="https://www.twitter.com/lottuxmed" class="btn btn-neutral btn-icon btn-twitter btn-round btn-lg" rel="tooltip" title="Follow us">
                <i class="fab fa-twitter"></i>
              </a>
              <a target="_blank" href="https://www.facebook.com/lottuxmed" class="btn btn-neutral btn-icon btn-facebook btn-round btn-lg" rel="tooltip" title="Like us">
                <i class="fab fa-facebook-square"></i>
              </a>
              <a target="_blank" href="https://www.linkedin.com/company-beta/lottuxmed/" class="btn btn-neutral btn-icon btn-linkedin btn-lg btn-round" rel="tooltip" title="Follow us">
                <i class="fab fa-linkedin"></i>
              </a>
              <a target="_blank" href="https://instagram.com/lottuxmed" class="btn btn-neutral btn-icon btn-instagram btn-round btn-lg" rel="tooltip" title="Star on Github">
                <i class="fab fa-instagram"></i>
              </a>
            </div>
          </div>
    ...
    <footer class="footer" data-background-color="black">
      <div class=" container ">
        {{-- <nav>
          <ul>
            <li>
              <a href="https://www.lottux.com">
                Lottux
              </a>
            </li>
            <li>
              <a href="http://presentation.creativetim.com">
                Sobre nosotros
              </a>
            </li>
            <li>
              <a href="http://blog.creativetim.com">
                Blog
              </a>
            </li>
          </ul>
